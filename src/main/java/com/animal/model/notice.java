...
public class notice {
	...
	public notice(int no, String category, String writer, String subject, String image01, String content,
	...
	public String toString() {
		return "notice [no=" + no + ", category=" + category + ", writer=" + writer + ", subject=" + subject
