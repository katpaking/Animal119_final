	...
	<input type="hidden" name="depth" value="${bean.depth}">
			...
			<div class="input-group">
				...
				<select id="category" name="category" class="form-select">
					<option value="-" selected="selected">${requestScope.bean.category}</option>
			...
			<div class="input-group">
				...
				<input id="fakeregdate" name="fakeregdate" disabled="disabled" type="datetime" class="form-control" placeholder=""  value="${requestScope.bean.regdate}">
