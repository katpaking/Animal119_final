				...
				<form action="<%=withFormTag%>" method="post"
					...
					<div class="input-group">
						<span class="input-group-text col-md-2">적립 포인트</span> <input
							id="point" name="fakepoint" disabled="disabled" type="number"
							class="form-control" placeholder=""> <input type="hidden"
							name="point" value="0">
					</div>
					<div class="input-group">
						<span class="input-group-text col-md-2">비고</span> <input
							id="remark" name="fakeremark" disabled="disabled" type="text"
							class="form-control" placeholder=""> <input type="hidden"
							name="remark" value="">
					</div>

					<div id="buttonset" class="input-group">
						<button type="submit" class="w-btn-outline w-btn-blue-outline"
							onclick="return validCheck();">등록</button>

						&nbsp;&nbsp;&nbsp;

						<button type="reset" class="w-btn-outline w-btn-red-outline">초기화</button>
					</div>
				</form>
			</div>
		</div>
