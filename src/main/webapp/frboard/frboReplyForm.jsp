...
<body>
	<div class="container mt-3 col-md-5">
		...
		<form action="<%=withFormTag%>" method="post">
			<input type="hidden" name="command" value="frboReply">
			...
			<div id="boardCategory" class="input-group">
				<span class="input-group-text col-md-2">게시물 카테고리</span> 
				<input id="category" name="category" type="text" class="form-control" placeholder="" value="<%=request.getParameter("category")%>">				
			</div>  
