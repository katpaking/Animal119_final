  	...
  	<script type="text/javascript">
  		...
  		function validCheck(){
  			...
  			if(point == '' || isNaN(point) == true){
  				...
  				if(numPoint < 0 || numPoint > 10000){
  					alert('포인트는 0이상 10000이하의 값이어야 합니다.');
  	  				$('#point').focus();
  	  				return false ;
  				}
  			}  		
...
<body>
	<div class="container mt-3 col-md-5">
		<img src="<%=contextPath%>/image/newProduct.png" alt="img" class="d-block" height="60">
		...
		<form action="<%=withFormTag%>" method="post" enctype="multipart/form-data">
			...
			<div class="input-group">
				<span class="input-group-text col-md-2" hidden>비고</span> 
				<input id="remark" name="remark" disabled="disabled" type="text" class="form-control" placeholder="" hidden>
			</div>			
