...
<body>
	...
	<div class="container mt-3">
		<div class="row">
			<div class="col-2">
				<img src="<%=contextPath%>/image/shop.png" alt="img" class="d-block" height="80">
			</div>			
		</div>		
                            ...
                            <b>적립포인트 : </b>${bean.point}<br/>
	    							...
	    							<c:if test="${whologin == 2}">
	    								...
	    								<div id="buttonList">
	    									...
	    									<a id="deleteAnchor" class="btn btn-danger" href="<%=notWithFormTag%>prDelete&num=${bean.num}${requestScope.pageInfo.flowParameter}">
		    									삭제
		    								</a>		    								
	    								</div>		    							
	    							</c:if>
