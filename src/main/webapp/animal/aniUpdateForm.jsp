...
<body>
	<div class="container mt-3 col-md-5">
		...
		<form action="<%=withFormTag%>" method="post" enctype="multipart/form-data">			
			<input type="text" name="command" value="aniUpdate">
			...
			<div id="animalNum" class="input-group">
			...
			<div class="input-group">
				...
				<input id="name" name="name" type="text" class="form-control" placeholder="" value="이름을 입력">
			</div>
			<div class="input-group">
			...
			<div class="input-group">
				...
				<input id="kind" name="kind" type="text" class="form-control" placeholder="" value="품종 입력">
			</div>
			<div class="input-group">
				<span class="input-group-text col-md-2">성별</span> 
				<select id="anigender" name="anigender" class="form-select form-select-lg">
					<option value="-">-- 항목을 선택해 주세요.</option>
